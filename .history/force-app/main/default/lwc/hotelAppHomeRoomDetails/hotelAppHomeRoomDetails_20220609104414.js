...
export default class HotelAppHomeRoomDetails extends NavigationMixin(LightningElement) {
  ...
  subscribeHandler(){
       this.roomIdSubscription =  subscribe(this.messageContext,SELECTED_ID,(message)=>this.handleCarSelected(message))
    }
    ...
    handleSelectedId(message){
        ...
        console.log('handle selected car is' ,this.recordId )
    }
