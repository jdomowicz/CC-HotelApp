...
export default class HotelAppHomeRoomDetails extends NavigationMixin(LightningElement) {
  ...
  subscribeHandler(){
       this.roomIdSubscription =  subscribe(this.messageContext,SELECTED_CAR_MESSAGE,(message)=>this.handleCarSelected(message))
    }
    ...
    connectedCallback() {
        ...
        console.log('connected callback is called after message subscription');
