    ...
    rooomData({ data, error }) {
        if (data) {
            ...
            this.room = {
                ...
                Available__c: data.fieldsAvailable__c.value,
                Mini_Bar__c: data.Mini_Bar__c.value,
                photo_url__c: data.photo_url__c.value,
                Room_Number__c: data.Room_Number__c.value,
                Type__c: data.Type__c.value,
                tv__c: data.tv__c.value
            }
