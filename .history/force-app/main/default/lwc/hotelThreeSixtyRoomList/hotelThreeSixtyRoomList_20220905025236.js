   ...
   subscribeToMessageChannel() {
    ...
    connectedCallback(){
     ...
     getSelectedName(event) {
        ...
        this.publishEventRoomList(this.selectedRooms);
    }


    publishEventRoomList(selectedRoomsIds){
        console.log('publishEventRoomList triggered data:', selectedRoomsIds);
            // Creates the event with the contact ID data.
        const selectedEvent = new CustomEvent('selected', { detail: selectedRoomsIds });
        console.log(selectedEvent.deti);
