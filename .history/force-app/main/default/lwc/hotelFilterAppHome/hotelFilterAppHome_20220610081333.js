...
export default class HotelFilterAppHome extends LightningElement {
    ...
    filters={
        ...
        country:this.countrySelectedValue,
        city:this.citySelectedValue,
        date:this.reservationDates,
        noGuests:this.numberofGuests,
        available:this.availableSelected,
        type:this.roomTypePicklistSelected
    ...
    handleCountryChange(event){
        ...
        this.getCityList();
        this.getHotelsList();
        console.log(this.countrySelectedValue)
