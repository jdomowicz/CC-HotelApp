...
export default class HotelFilterAppHome extends LightningElement {
    ...
    //Default Values
    countrySelectedValue = 'United States';
    citySelectedValue;
    ...
    getCityList(){
        ...
        cityList({countryName:countrySelectedValue}).then((result)=>{

            this.countryFilteredList = result;
            console.log(this.countryFilteredList)
