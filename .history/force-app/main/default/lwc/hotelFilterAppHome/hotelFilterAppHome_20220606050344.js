...
export default class HotelFilterAppHome extends LightningElement {
    ...
    getCityList(){
        ...
        cityListWithArguments({countryName:this.countrySelectedValue}).then((result)=>{
            ...
            console.log('apex loaded data is',this.cityFilteredList)

            result.forEach(element => {
              this.cityFilteredList = [...this.cityFilteredList2,{"label":element.City__c, "value":element.City__c}];
              console.log(this.cityFilteredList2)
           });
