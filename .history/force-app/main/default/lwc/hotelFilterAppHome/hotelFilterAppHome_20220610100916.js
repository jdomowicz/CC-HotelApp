...
export default class HotelFilterAppHome extends LightningElement {
    ...
    handleTypeChange(event){
        ...
        console.log(this.filters[roomtypes])

       // this.filters[romtypes].forEach(element=>{

          //  if(element.includes(event.target.dataset.id))
         //   {
              //  console.log(element)
         //   }
      ...
      //  })
        ...
        //this.roomSelected = [...this.roomSelected,{label:event.target.dataset.id,value:event.target.checked}];
