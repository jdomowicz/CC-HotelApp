...
import cityList from '@salesforce/apex/HotelController.cityListWithArguments';
...
export default class HotelFilterAppHome extends LightningElement {
    ...
    getHotelsList(){
        ...
        hotelsList({countryName:this.countrySelectedValue , cityName:this.citySelectedValue}).then((result)=>{
            ...
            result.forEach(element => {
              this.hotelSelectOptions = [...this.hotelSelectOptions,{"label":element.Name, "value":element.Name,"Id":element.Id}];
           });
    ...
    get hotelSelectOptions() {
        return this.hotelSelectOptions;
    }
