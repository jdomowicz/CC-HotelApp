...
export default class HotelFilterAppHome extends LightningElement {
    ...
    handleDateChange(event) {
        ...
        if(!this.filters.reservationDates){
        ...
        //this.filters.reservationDates = [ ...this.filters.reservationDates,{dateName:event.target.dataset.nm,dateValue:event.target.value}];
        this.filters = { ...this.filters, (event.target.dataset.nm: event.target.value };
