...
export default class HotelFilterAppHome extends LightningElement {
    ...
    handleDateChange(event){
        ...
        this.filters = [...this.filters,{label:event.target.dataset.nm,value:event.target.value}];
    ...
    handleTypeChange(event){
        ...
        this.filters = [...this.filters,{type:event.target.dataset.id,value:event.target.checked}];
    ...
    handleAvailableChange(event){
        ...
        this.filters = [...this.filters,{available:event.target.dataset.id,value:event.target.checked}];
