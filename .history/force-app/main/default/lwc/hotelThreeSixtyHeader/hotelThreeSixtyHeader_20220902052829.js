...
@wire(MessageContext)
 ...
 gethotelListDropdown() {
        ...
        hotelListDropdown().then((result) => {
            ...
            console.log('rating star is ',this.hotelRating);

            switch(this.hotelRating){
            ...
            handleRatingStar(this.hotelRating);
    ...
    handleRatingStar(data){
        console.log('handleRatingStar triggered',data);
    }
