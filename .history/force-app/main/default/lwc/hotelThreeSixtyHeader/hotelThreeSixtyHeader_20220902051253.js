 ...
 gethotelListDropdown() {
        ...
        hotelListDropdown().then((result) => {
            ...
            result.forEach(element => {
                this.hotelList = [...this.hotelList, { "label": element.Name, "value": element.Id, "Id": element.Id,"Rooms_Available__c":element.Rooms_Available__c,"Rating__c":element.Rating__c ,,"RatingStar":element.Rating__c }];
            });
            this.hotelValue =  this.hotelList[0].Id;
            console.log('hotel value = ',this.hotelValue);
            this.hotelRating = this.hotelList[0].RatingStar;
