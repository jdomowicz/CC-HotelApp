 ...
 gethotelListDropdown() {
        ...
        hotelListDropdown().then((result) => {
            ...
            result.forEach(element => {
                this.hotelList = [...this.hotelList, { "label": element.Name, "value": element.Id, "Id": element.Id,"Rooms_Available__c":element.Rooms_Available__c,"Rating__c":element.Rating__c ,,"Rating__c":element.Rating__c }];
            });
